...
Tích hợp VansRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model VansRouter có sẵn:
...
### Connection Failed
- Xác minh VansRouter đang chạy: `curl http://localhost:20128/health`
