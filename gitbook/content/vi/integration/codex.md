...
Tích hợp VansRouter với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của VansRouter.
...
VansRouter cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong VansRouter dashboard
...
1. Xác minh tên model khớp với cấu hình VansRouter
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong VansRouter dashboard
...
Đảm bảo bạn đã cấu hình API key trong VansRouter cloud dashboard.
