...
Tích hợp VansRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- VansRouter API key từ [dashboard](http://localhost:20128/dashboard)
- VansRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model VansRouter
...
3. Chọn model VansRouter ưa thích
...
- Kiểm tra VansRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến VansRouter
