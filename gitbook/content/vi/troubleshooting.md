...
Các vấn đề và giải pháp phổ biến khi dùng VansRouter.
...
1. **Auto-refresh (mặc định):**
   VansRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- VansRouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động VansRouter:**
   ```bash
   vansrouter
   ```
...
1. **Kiểm tra VansRouter có chạy không:**
   ```bash
   # Check process
   ps aux | grep 9router
