...
VansRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをVansRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはVansRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がVansRouterの設定と一致しているか確認
