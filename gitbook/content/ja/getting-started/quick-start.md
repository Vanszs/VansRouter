...
VansRouterを5分で起動し、AIリクエストをインテリジェントにルーティングし始めましょう。
...
**要件:** Node.js 22.5+ ([インストール詳細](getting-started/installation.md))
...
- 新規インストール時のデフォルトは `123456` です。公開前にランダムな `INITIAL_PASSWORD` を設定してください。
- APIキーは自動生成
- プロバイダー接続の準備完了
