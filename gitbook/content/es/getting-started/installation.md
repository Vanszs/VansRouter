...
Guía detallada de instalación de VansRouter con consejos de solución de problemas.
...
Instala VansRouter globalmente para usar desde cualquier lugar:
...
- ✅ Auto-actualizaciones con `npm update -g vansrouter`
...
- Contraseña inicial: configura un valor aleatorio fuerte en `INITIAL_PASSWORD`
...
**Problema:** VansRouter usa demasiada RAM
