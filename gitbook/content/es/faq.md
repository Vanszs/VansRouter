...
Preguntas comunes sobre VansRouter.

---

## ¿Qué es VansRouter?

**VansRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**VansRouter usa una estrategia de precios de 3 niveles:**
...
## ¿VansRouter es gratis?

**Sí, VansRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de VansRouter.**
...
**VansRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar VansRouter?

**¡Sí! VansRouter soporta múltiples opciones de despliegue:**
...
- `INITIAL_PASSWORD` - Login del dashboard (las instalaciones nuevas usan `123456`; configura un valor fuerte antes de exponerlas)
...
**Sí, VansRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.9router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de VansRouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/Vanszs/VansRouter/blob/main/CHANGELOG.md)
...
Consulta [CONTRIBUTING.md](https://github.com/Vanszs/VansRouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [VansRouter docs](https://github.com/Vanszs/VansRouter/blob/main/README.md)
