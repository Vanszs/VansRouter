...
Despliega VansRouter en VPS o Docker para acceso remoto y uso en producción.
...
| `INITIAL_PASSWORD` | `123456` para instalaciones nuevas | Configura una contraseña fuerte antes de exponerla |
...
# Si NO usas proxy reverso, permite los puertos de VansRouter
...
```bash
# Verificar si VansRouter está corriendo
pm2 status
