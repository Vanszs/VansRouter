...
VansRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

VansRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a VansRouter usando estas configuraciones:

**VansRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de VansRouter (cc/*, cx/*, glm/*, etc.)
```

**VansRouter en la nube:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de VansRouter (cc/*, cx/*, glm/*, etc.)
...
**Problema:** No se puede conectar a VansRouter
```bash
# Verifica si VansRouter está corriendo
...
**Solución:**
- Verifica que VansRouter esté corriendo
...
- Verifica la conexión de red a VansRouter
