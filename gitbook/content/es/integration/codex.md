...
Integra VansRouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de VansRouter.
...
VansRouter proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-vansrouter-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de VansRouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de VansRouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de VansRouter
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de VansRouter.
