...
Integra VansRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de VansRouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- VansRouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de VansRouter:

**Para VansRouter local:**
```
http://localhost:20128/v1
```

**Para VansRouter en la nube:**
```
http://localhost:20128
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de VansRouter
...
3. La key debe comenzar con `sk-your-key-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de VansRouter
...
4. Cline usará VansRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando VansRouter
...
3. Obtén explicaciones potenciadas por IA a través de VansRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará VansRouter para entender el contexto y hacer cambios
...
1. Verifica que VansRouter esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de VansRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de VansRouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de VansRouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `http://localhost:20128`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de VansRouter
...
## Integración con características de VansRouter

### Enrutamiento de modelos

VansRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, VansRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de VansRouter:
