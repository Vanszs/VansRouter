...
Integrate VansRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- VansRouter API key from [dashboard](http://localhost:20128/dashboard)
- VansRouter running (local or cloud)
...
### 2. Add VansRouter Model Configuration
...
3. Choose your preferred VansRouter model
...
- Check network latency to VansRouter
