...
Integrate VansRouter with Claude Code CLI to route your Anthropic API requests through VansRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to VansRouter models:
