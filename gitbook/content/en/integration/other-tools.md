...
VansRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

VansRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to VansRouter using these settings:

**Local VansRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any VansRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to VansRouter
```bash
...
- Check network connection to VansRouter
