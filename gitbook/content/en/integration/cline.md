...
Integrate VansRouter with Cline VSCode extension to route your AI requests through VansRouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- VansRouter running locally or cloud endpoint configured
...
Set the base URL to your VansRouter endpoint:

**For Local VansRouter:**
```
http://localhost:20128/v1
```

**For Cloud VansRouter:**
```
http://localhost:20128
```

**Steps:**
1. In the **Base URL** field, enter your VansRouter endpoint
...
3. The key should start with `sk-your-key-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your VansRouter configuration
...
4. Cline will use VansRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using VansRouter
...
3. Get AI-powered explanations through VansRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use VansRouter to understand context and make changes
...
1. Verify VansRouter is running: `curl http://localhost:20128/health`
...
2. Verify your VansRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check VansRouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use VansRouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `http://localhost:20128`
2. Make sure you have configured your API key in the VansRouter cloud dashboard
...
## Integration with VansRouter Features

### Model Routing

VansRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, VansRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through VansRouter dashboard:
- Total requests
- Token usage
- Cost per model
