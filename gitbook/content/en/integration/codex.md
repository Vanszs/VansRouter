...
Integrate VansRouter with OpenAI Codex CLI to route your OpenAI API requests through VansRouter's intelligent routing system.
...
VansRouter provides the following Codex models:
...
1. Verify your API key is correct in VansRouter dashboard
...
1. Verify the model name matches your VansRouter configuration
2. Check that the OpenAI provider connection is active in VansRouter dashboard
...
Make sure you have configured your API key in the VansRouter cloud dashboard.
