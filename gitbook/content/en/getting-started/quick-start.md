...
Get VansRouter running in 5 minutes and start routing AI requests intelligently.
...
**Requirements:** Node.js 22.5+ ([Installation details](getting-started/installation.md))
...
🎉 **Dashboard opens automatically** at `http://localhost:20128/masuk`
...
Point your coding tool to VansRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from vansrouter dashboard]
