export default {
  ...
  display: {
    ...
    notice: {
      text: "OpenCode Zen pay-as-you-go: API key from https://opencode.ai/auth.",
  ...
  // translation. Mirrors opencode-go, pointed at /zen/v1.
  transports: [
    {
      format: "openai",
      baseUrl: "https://opencode.ai/zen/v1/chat/completions",
  ...
  models: [
    ...
    // DeepSeek / GLM / MiniMax / Kimi / Big Pickle / Union Alpha (chat completions)
